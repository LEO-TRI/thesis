...
#gbt_dict = {'classifier__l2_regularization': 0.08724089624421172, 'classifier__learning_rate': 0.1693869208177845, 'classifier__max_bins': 192, 'classifier__max_depth': 3, 'classifier__max_iter': 129, 'classifier__max_leaf_nodes': 31, 'classifier__min_samples_leaf': 27, 'preprocessing__text__selectkbest__k': 1300, 'preprocessing__text__text_preprocessing__text1__ngram_range': (1, 3), 'preprocessing__text__text_preprocessing__text1__norm': 'l1', 'preprocessing__text__text_preprocessing__text2__ngram_range': (1, 2), 'preprocessing__text__text_preprocessing__text2__norm': 'l1', 'preprocessing__text__text_preprocessing__text3__ngram_range': (1, 1), 'preprocessing__text__text_preprocessing__text3__norm': 'l2'}
...
logistic_dict = {'classifier__C': 4.316822254688309, 'classifier__penalty': 'l2', 'preprocessing__text__selectkbest__k': 1600, 'preprocessing__text__text_preprocessing__text1__ngram_range': (1, 3), 'preprocessing__text__text_preprocessing__text1__norm': 'l1', 'preprocessing__text__text_preprocessing__text2__ngram_range': (1, 3), 'preprocessing__text__text_preprocessing__text2__norm': 'l2', 'preprocessing__text__text_preprocessing__text3__ngram_range': (1, 3), 'preprocessing__text__text_preprocessing__text3__norm': 'l1'}
random_forest_dict = {'preprocessing__text__text_preprocessing__text3__norm': 'l1', 'preprocessing__text__text_preprocessing__text3__ngram_range': (1, 1), 'preprocessing__text__text_preprocessing__text2__norm': 'l2', 'preprocessing__text__text_preprocessing__text2__ngram_range': (1, 2), 'preprocessing__text__text_preprocessing__text1__norm': 'l2', 'preprocessing__text__text_preprocessing__text1__ngram_range': (1, 3), 'preprocessing__text__selectkbest__k': 300, 'classifier__n_estimators': 90, 'classifier__min_samples_split': 7, 'classifier__min_samples_leaf': 37, 'classifier__max_leaf_nodes': 51,'classifier__max_features': 'sqrt', 'classifier__max_depth': 9}
xgb_dict = {'classifier__booster': 'dart', 'classifier__learning_rate': 0.28678587356189345, 'classifier__max_bin': 120, 'classifier__max_delta_step': 4, 'classifier__max_depth': 6, 'classifier__n_estimators': 35, 'classifier__num_parallel_tree': 3, 'classifier__reg_alpha': 0.3525255047141329, 'preprocessing__text__selectkbest__k': 800, 'preprocessing__text__text_preprocessing__text1__ngram_range': (1, 3), 'preprocessing__text__text_preprocessing__text1__norm': 'l1', 'preprocessing__text__text_preprocessing__text2__ngram_range': (1, 2), 'preprocessing__text__text_preprocessing__text2__norm': 'l2', 'preprocessing__text__text_preprocessing__text3__ngram_range': (1, 1), 'preprocessing__text__text_preprocessing__text3__norm': 'l2'}
gbt_dict = {'classifier__l2_regularization': 0.35902293388344686, 'classifier__learning_rate': 0.3067256124919674,  'classifier__max_bins': 253,  'classifier__max_depth': 4,  'classifier__max_iter': 129, 'classifier__max_leaf_nodes': 5, 'classifier__min_samples_leaf': 11, 'preprocessing__text__selectkbest__k': 2000, 'preprocessing__text__text_preprocessing__text1__ngram_range': (1, 2),'preprocessing__text__text_preprocessing__text1__norm': 'l1', 'preprocessing__text__text_preprocessing__text2__ngram_range': (1, 2), 'preprocessing__text__text_preprocessing__text2__norm': 'l2','preprocessing__text__text_preprocessing__text3__ngram_range': (1, 2), 'preprocessing__text__text_preprocessing__text3__norm': 'l2'}
...
stacked_dict = {'classifier__final_estimator__C': 4.605904660560077,
                'classifier__final_estimator__penalty': 'l2',
                'classifier__gbt__l2_regularization': 0.38956470255157116,
                'classifier__gbt__learning_rate': 0.5933264721099493,
                'classifier__gbt__max_bins': 68,
                'classifier__gbt__max_depth': 4,
                'classifier__gbt__max_leaf_nodes': 39,
                'classifier__rf__max_depth': 4,
                'classifier__rf__max_features': 'sqrt',
                'classifier__rf__max_leaf_nodes': 35,
                'classifier__rf__min_samples_leaf': 22,
                'classifier__rf__min_samples_split': 35,
                'classifier__rf__n_estimators': 60,
                'preprocessing__text__selectkbest__k': 800,
                'preprocessing__text__text_preprocessing__text1__ngram_range': (1, 1),
                'preprocessing__text__text_preprocessing__text1__norm': 'l2',
                'preprocessing__text__text_preprocessing__text2__ngram_range': (1, 3),
...
gNB_dict = {'preprocessing__text__text_preprocessing__text3__norm': 'l1',
            'preprocessing__text__text_preprocessing__text3__ngram_range': (1, 2),
            ...
            'preprocessing__text__selectkbest__k': 1600}
...
#xgb_dict = {'classifier__booster': 'gbtree', 'classifier__learning_rate': 0.26345511271971045, 'classifier__max_bin': 180, 'classifier__max_delta_step': 4, 'classifier__max_depth': 7, 'classifier__n_estimators': 50, 'classifier__num_parallel_tree': 4, 'classifier__reg_alpha': 0.9023314390173538,'preprocessing__text__selectkbest__k': 800, 'preprocessing__text__text_preprocessing__text1__ngram_range': (1, 1), 'preprocessing__text__text_preprocessing__text1__norm': 'l1', 'preprocessing__text__text_preprocessing__text2__ngram_range': (1, 2), 'preprocessing__text__text_preprocessing__text2__norm': 'l1', 'preprocessing__text__text_preprocessing__text3__ngram_range': (1, 1), 'preprocessing__text__text_preprocessing__text3__norm': 'l1'}
